...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div className="container p-2  lg:p-10  lg:ml-12">
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between px-4 md:px-8 pt-12 lg:pt-20 pb-24 lg:pb-32 relative z-10">
          {/* Left Text Content */}
          <div className="flex-1 space-y-6 text-left">
            ...
            <div className="mt-4 ml-32 flex items-center gap-3 p-3 rounded-md shadow bg-white w-fit">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-xs">
                  Up to{" "}
                  <span className="text-green-600 font-bold">70% off</span>
                </p>
